...
import { showUsers, deleteUser } from "../../../apis/api";
...
export default function UsersTable() {
  ...
  const usersData = users.map((user) => (
    <tr key={user.id} className="border-b dark:border-neutral-500 bg-blue-100">
  ...
  //End generate table rows for each user
                ...
                <tr className="bg-blue-500">
                  ...
                  <th scope="col" className="px-6 py-4">
                    <button
                      ...
                      onClick={() => {
                        window.location.pathname = "/dashboard/users/create";
                      }}
                    >
                      Add New User
                    </button>
